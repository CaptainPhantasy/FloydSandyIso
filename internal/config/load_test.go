...
func TestConfig_setupAgentsWithDisabledTools(t *testing.T) {
	...
	assert.Equal(t, []string{"agent", "bash", "parallel_bash", "context_status", "complexity_estimator", "refactor_blueprint", "failure_mode_enumerator", "job_output", "job_kill", "multiedit", "lsp_diagnostics", "lsp_references", "lsp_restart", "fetch", "glob", "ls", "sourcegraph", "symbol_index", "todos", "view", "vision", "workflow", "write"}, coderAgent.AllowedTools)
...
func TestConfig_setupAgentsWithEveryReadOnlyToolDisabled(t *testing.T) {
	...
	coderAgent, ok := cfg.Agents[AgentCoder]
	require.True(t, ok)
	assert.Equal(t, []string{"agent", "bash", "parallel_bash", "context_status", "complexity_estimator", "refactor_blueprint", "failure_mode_enumerator", "job_output", "job_kill", "download", "edit", "multiedit", "lsp_diagnostics", "lsp_references", "lsp_restart", "fetch", "symbol_index", "todos", "vision", "workflow", "write"}, coderAgent.AllowedTools)
